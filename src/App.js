...
const Character = ({ character: { name, image } }) => (
...
const Characters = ({ characters = dataCharacters }) => (
...
// const CharacEpis = ({ characters = dataEpisodes }) => {
//   <ul className="CharacEpis">
//     {characters.map((character) => (
//       <li>{charackters.name}</li>
//     ))}
//   </ul>;
// };
...
const Episode = ({ episode: { name, air_date, characters } }) => (
  <div className="Episode">
    ...
    {/* <CharacEpis characters={character} /> */}
  </div>
);
const Episodes = ({ episodes = dataEpisodes }) => (
